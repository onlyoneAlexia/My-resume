...
console.log('%c👋 Hey there!', 'font-size: 20px; color: #E88AB5; font-weight: bold;');
console.log('%cInterested in Web3 development?', 'font-size: 14px; color: #9966CC;');
console.log('%cLet\'s connect and build the decentralized future together! 🚀', 'font-size: 14px; color: #E88AB5;');
